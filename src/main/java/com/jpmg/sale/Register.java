package com.jpmg.sale;


public class Register {
//    Map<Instruction, List<Transaction>> records;
//
//    public Register() {
//        this.records = new HashMap<>();
//    }
//
//    public Register(Map<Instruction, List<Transaction>> records) {
//        this.records = records;
//    }
//
//    public Map<Instruction, List<Transaction>> getRecords() {
//        return records;
//    }
//
//    public boolean addProduct(Instruction product) {
...
//        }
//
//        Instruction product = findProduct(message.getType());
//        if(product == null) {
...
//    }
//
//    private Instruction findProduct(String productType) {
//        Set<Instruction> products = records.keySet();
//
//        for(Instruction product : products) {
...
//        for(Map.Entry<Instruction, List<Transaction>> record : records.entrySet()) {
